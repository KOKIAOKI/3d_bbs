...
def generate_launch_description():
    ...
    finger_snap_node = launch_ros.actions.Node(
        package='finger_snap',
        executable='finger_snap',
        output='screen',
    )

    return launch.LaunchDescription([rviz_node, gpu_ros2_test_rviz2, click_loc_node, finger_snap_node])
